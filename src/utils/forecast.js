    ...
    request({url, json: true},(error,response)=>{
        if (error) {
            ...
            callback(undefined, 
                ...
                <b>DATA:</b><br>Temperature is actually ${response.body.current.temperature}° F but feels like ${response.body.current.feelslike}° F !<br>
                <b>Precipitation:</b> ${response.body.current.precip} Inches<br>
                <b>Wind:</b> ${response.body.current.wind_speed} Miles/Hour ${response.body.current.wind_dir} <br>
